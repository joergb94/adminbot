        ...
        <tr>
            ...
            <td style="vertical-align: top; width:280px;">
                <table class="table_data w-full">
                    ...
                    <tr><td class="{{$titleCellStyle}} basis-36">REFERENCIA</td><td>{{isset($cpOrder['purchase_order'])?$cpOrder['purchase_order']:''}}</td></tr>
        ...
        <tr>
            <td colspan="3" style="width:840px;" class="pt-5">
                ...
                <table class="table_data w-full border-collapse">
                    ...
                    @foreach($cpOrder['products'] as $product)
                        <tr>
                    ...
                    @endforeach
                    @for ($i = 0; $i < ( $max - count($cpOrder['products']) ); $i++)
